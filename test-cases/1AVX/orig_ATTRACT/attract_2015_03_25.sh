...
(time python $ATTRACTDIR/../protocols/attract.py $start $params --grid 1 receptorgrid.gridheader --vmax 1000 --output out_$name.dat --np 8 --chunks 8 ) 2> $name.docking.8t.time
#python $ATTRACTDIR/../protocols/attract.py $start $params --grid 1 receptorgrid.gridheader --vmax 1000 --output out_$name.dat --np 8 --chunks 8
$ATTRACTDIR/shm-clean
