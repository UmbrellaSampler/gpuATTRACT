...
$ASDIR/mcATTRACT --dof systsearch-ens1-ens2.dat -p $ATTRACTDIR/../attract.par -a receptorgrid.alphabet -d 0 -w 10 -w 5 -w 5 --ensProb 1.0 --iter 2000 --ub 54.4 --rstk 0.02 --maxDist 0.1 --kT 0.8 --maxAng 1.0 > out_$name.dat
